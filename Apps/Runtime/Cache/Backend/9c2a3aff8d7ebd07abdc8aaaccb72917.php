...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="<?php echo U('taskAdd');?>" class="btn btn-primary"><i class="icon-plus"></i> 添加任务</a>
</div>
...
<div class="block">
    ...
    <div id="page-stats" class="block-body collapse in">
        <table class="table table-striped">
            ...
            <tbody>
            <?php if(is_array($tasks)): foreach($tasks as $key=>$task): ?><tr>

                    <td><?php echo ($task["id"]); ?></td>

                    <td><?php echo ($task["task_name"]); ?></td>

                    <td><?php echo (date("Y-m-d H:i:s",$task["create_time"])); ?></td>

                    <td>
                        <a href="<?php echo U('taskModify',array('id'=>$task['id']));?>" title= "编辑" ><i class="icon-pencil"></i></a>
                        &nbsp;
                        <a data-toggle="modal" href="<?php echo U('task',array('id'=>$task['id'],'method'=>del));?>" title= "删除" ><i class="icon-remove"></i></a>
