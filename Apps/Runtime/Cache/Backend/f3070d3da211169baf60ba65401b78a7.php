	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="">
				...
				<label>配置url</label>
				<textarea id="config_content" name="config_content" rows="3" class="input-xlarge"><?php echo (htmlspecialchars($config["config_content"])); ?></textarea>
                ...
                <div class="theme-popover" style="overflow: auto;">
                 ...
                 <div action="" method="post">
                     <?php if(is_array($configArrs)): foreach($configArrs as $key=>$configArr): if(!empty($configArr.config_content)): ?><label><input name="config_contents[]" type="checkbox" value="<?php echo ($configArr["config_content"]); ?>">
                            <?php echo ($configArr["config_content"]); ?></label><?php endif; endforeach; endif; ?>
                 </div>
