...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">修改广告商激活配置信息资料</a></li>
    </ul>	
	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="">
				...
				<label>配置url</label>
				<textarea  id="config_content" name="config_content" rows="3" class="input-xlarge"><?php echo ($config["config_content"]); ?></textarea>
                ...
                <div action="" method="post">
                    <?php if(is_array($configArrs)): foreach($configArrs as $key=>$configArr): if(!empty($configArr.config_content) ): ?><label><input name="config_contents[]" type="checkbox" value="<?php echo ($configArr["config_content"]); ?>">
                            <?php echo (htmlspecialchars($configArr["config_content"])); ?> </label><?php endif; endforeach; endif; ?>
                     </div>
				...
				<textarea id="config_if" name="config_if" rows="5" class="input-xlarge" onchange="return change();"><?php echo ($config["config_if"]); ?></textarea>
