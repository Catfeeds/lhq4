...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="<?php echo U('activeConfig_add');?>" class="btn btn-primary"><i class="icon-plus"></i> 添加广告主激活配置信息</a>
</div>
<form class="form_search"  action="/lhq/Backend/Providerconfig/activeConfig" method="GET" style="margin-bottom:0px">
...
<div class="block">
	...
	<table class="table table-striped">
			...
			<?php if(is_array($configs)): foreach($configs as $key=>$config): ?><tr>
				...
				<td>
					<a href="<?php echo U('Providerconfig/activeConfig_modify',array('config_id'=>$config['config_id']));?>" title= "修改" ><i class="icon-pencil"></i></a>
					
					&nbsp;
					<a data-toggle="modal" href="<?php echo U('Providerconfig/activeConfig',array('config_id'=>$config['config_id'],'method'=>del));?>" title= "删除" ><i class="icon-remove"></i></a>
				</td>
