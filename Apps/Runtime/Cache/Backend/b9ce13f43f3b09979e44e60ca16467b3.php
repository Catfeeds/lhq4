...
<div style="border:0px;padding-bottom:5px;height:auto">
    ...
    <div style="float:left;margin-right:5px">
		<label>关键词:</label>
		<input type="text" style="width: 350px;" name="kid" value="<?php echo ($_GET["kid"]); ?>" placeholder="输入关键词" >
	</div>
...
<div class="block">
	<a href="#page-stats" class="block-heading" data-toggle="collapse">渠道激活上报日志</a>
	...
	<table class="table table-striped">
			...
			<?php if(is_array($clogs)): foreach($clogs as $key=>$clog): ?><tr>
			    ...
			    <td><?php echo ($clog["result"]); ?></td>

			    <td><?php echo ($clog["own_result"]); ?></td>
