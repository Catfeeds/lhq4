...
function() {
    ...
    ysf.config = function(e) {
        if (e) {
            ...
            if (cache.appKey) {
                ...
                visit();
                syncProfile();
                if (e.bid) initWinConfigTrade();
                else initWinConfig()
            }
        }
    };
    ysf.configTrade = function(e) {
        if (e) {
            merge(e);
            if (cache.appKey) {
                refresh(e.uid);
    ...
    ysf.url = function(e) {
        ...
        if (e) return ysf.IMROOT + "/trade?" + serialize(t);
        else return ysf.IMROOT + "?" + serialize(t)
    };
    ysf.logoff = function() {
        updateDevice();
    ...
    ysf.open = function() {
        if (cache.bid) var e = ysf.url.apply(ysf, [!0]);
        else var e = ysf.url.apply(ysf);
    ...
    ysf.clearDragresize = function(e) {
        try {
            ...
            else for (var i = 0; i < n.length; i++) util.clearLocalItems(util.findLocalItems(new RegExp(t + "-" + n[i], "ig")))
        } catch(a) {}
    }
} ();
var __YSFOPTION__ = {
    ...
    sdkCustom: 1,
    hidden: 1,
    appKey: '3c8e4152b8a8ee8eba1048e03212caf3'
};
...
__YSFOPTION__.imgSrc = 'https://nos.netease.com/ysf/6E3D271993CDEE93FE0B5E50332DE550?imageView&thumbnail=300x300';
...
ysf.init('https://nos.netease.com/ysf/6E3D271993CDEE93FE0B5E50332DE550?imageView&thumbnail=300x300');