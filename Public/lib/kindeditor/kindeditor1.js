...
(function (b, d) {
    ...
    function h(a, c) {
        if (f(a))
            for (var g = 0, b = a.length; g < b; g++) {
                ...
                for (g in a)
                    if (a.hasOwnProperty(g) && c.call(a[g], g, a[g]) === !1) break
    }
    ...
    function z(a, c) {
        ...
        h(b, function (a, c) {
            if (t = /^(\d+)\.\.(\d+)$/.exec(c))
                for (var b = parseInt(t[1], 10); b <= parseInt(t[2], 10); b++) g[b.toString()] = !0;
            else g[c] = !0
        });
        return g
    }
        ...
        function k(a, c, g) {
            ...
            if (g.getElementsByClassName) {
                ...
                for (w = d.length; k < w; k++)
                    if (i = d[k], i.nodeType == 1)(c = i.className) && (" " + c + " ").indexOf(a) > -1 && t.push(i)
            }
            return t
        }
        ...
        for (lenth = f.length; v < lenth; v++)
            if (m = f[v], m === ">") o = !0;
                ...
                if (v > 0) {
                    ...
                    l = s
                } else l = i(m, c); if (l.length === 0) return []
            }
        return l
    }
    ...
    function Ra(a, c, g) {
        ...
        function k(d, t) {
            for (var m = d.firstChild, s; m;) {
                ...
                if (h > 0)
                    if (m.nodeType == 1)
                        if (l >= 0 && n <= 0) c && t.appendChild(m.cloneNode(!0)), g && e.push(m);
                        else {
                            var j;
    ...
    function mb(a, c) {
        ...
        if (f > 0)
            for (; w.nextSibling && w.nodeType == 1;) w = w.nextSibling;
        h = a.duplicate();
        ua(h, d);
        ...
        e -= h.text.replace(/\r\n|\n|\r/g, "").length;
        if (f > 0 && w.nodeType == 3)
            for (g = w.previousSibling; g && g.nodeType == 3;) e -= g.nodeValue.length, g = g.previousSibling;
        return {
            node: w,
            offset: e
        }
    ...
    function db(a) {
        for (var c =
            document.getElementsByTagName("head")[0] || (da ? document.body : document.documentElement), g = document.createElement("link"), b = zb(R(a, "absolute")), d = i('link[rel="stylesheet"]', c), k = 0, w = d.length; k < w; k++)
            if (zb(R(d[k].href, "absolute")) === b) return;
        c.appendChild(g);
        g.href = a;
        g.rel = "stylesheet"
    }
    ...
    function Ha(a, c) {
        if (!a.collapsed) {
            var a = a.cloneRange().up(),
                ...
                b = a.startOffset;
            if (ka || a.isControl())
                if ((g = i(g.childNodes[b])) && g.name == "img" && c(g)) return g
        }
    }
        ...
        if (!(F && b !== "br") && (!la || !(N < 3 && b !== "p")) && !(Qa && N < 9)) {
            ...
            i(g).keyup(function (d) {
                if (!(d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey) && b != "br")
                    ...
                    } else if (c.cmd.selection(), d = a(c.cmd.range), !(d == "marquee" || d == "select"))
                    if (k[d] || ea(g, "formatblock", "<p>"), d = c.cmd.commonAncestor("div")) {
    ...
    function Ub() {
        ...
        i(c).keydown(function (g) {
            if (g.which == 9)
                if (g.preventDefault(), a.afterTab) a.afterTab.call(a, g);
                else {
                    var g = a.cmd,
                        b = g.range;
                    b.shrink();
    ...
    if (!b.KindEditor) {
        ...
        i.basePath = function () {
            for (var a =
                document.getElementsByTagName("script"), c, g = 0, b = a.length; g < b; g++)
                if (c = a[g].src || "", /kindeditor[\w\-\.]*\.js/.test(c)) return c.substring(0, c.lastIndexOf("/") + 1);
            return ""
        }();
        i.options = {
            designMode: !0,
        ...
        A(P, {
            init: function (a) {
                    ...
                    for (var c = 0; c < this.length; c++)
                        if (a.call(this[c], c, this[c]) === !1) break;
                    return this
                }, bind: function (a, c) {
                    this.each(function () {
                        E(this, a, c)
                ...
                data: function (a, c) {
                    ...
                    var a = this[0],
                        ...
                        g = 0;
                    if (a)
                        if (a.getBoundingClientRect) a = a.getBoundingClientRect(), g = na(this.doc), c = a.left + g.x, g = a.top + g.y;
                        else
                            for (; a;) c += a.offsetLeft, g += a.offsetTop, a = a.offsetParent;
                    return {
                        x: fa(c),
                        y: fa(g)
                    }
        ...
        A(aa, {
            init: function (a) {
                ...
                for (var c = a(this.startContainer),
                    b = a(this.endContainer), d = 0, i = c.length, k = b.length, e, f; ++d;)
                    if (e = c[i - d], f = b[k - d], !e || !f || e !== f) break;
                return c[i - d + 1]
        ...
        A(za, ga, {
            init: function (a) {
                ...
                for (var e = 0; e < c.length; e++)
                    for (var b = a.insertRow(e + 1), i = 0; i < c[e].length; i++) d = b.insertCell(i), this._addAttr(d, c[e][i], "ke-colorpicker-cell")
        ...
        A(bb, {
            init: function (a) {
                ...
                b = ['<div class="ke-inline-block ' + h + '">', a.target ? "" : '<iframe name="' + l + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' +
                    l + '" action="' + d + '">', '<span class="ke-button-common">', n.join(""), '<input type="button" class="ke-button-common ke-button" value="' + e + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + b + '" tabindex="-1" />', a.form ? "</div>" : "</form>", "</div>"
                ].join("");
                b = i(b, c.doc);
                c.hide();
                c.before(b);
...
KindEditor.plugin("baidumap", function (b) {
    ...
    d.clickToolbar("baidumap", function () {
        ...
        var m = ['<div style="padding:10px 20px;"><div class="ke-header"><div class="ke-left">', f.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' +
                f.search + '" />', '</span></div><div class="ke-right">', '<input type="checkbox" id="keInsertDynamicMap" name="insertDynamicMap" value="1" /> <label for="keInsertDynamicMap">' + f.insertDynamicMap + "</label>", '</div><div class="ke-clearfix"></div></div>', '<div class="ke-map" style="width:' + j + "px;height:" + e + 'px;"></div>', "</div>"
            ].join(""),
            m = d.createDialog({
                name: "baidumap",
                width: j + 42,
    ...
    d.plugin.flash = {
        edit: function () {
            var l = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + f.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
                    ...
                    f.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /> </div></div>'
                ].join(""),
                s = d.createDialog({
                    name: "flash",
                    width: 450,
        ...
        var C = ['<div style="padding:20px;"><div class="tabs"></div><div class="tab1" style="display:none;"><div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' +
            ...
            I = d.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function () {
                        if (!I.isLoading)
                            if (q && j && H && H.selectedIndex === 1 || !j) U.fileBox.val() == "" ? alert(d.lang("pleaseSelectFile")) : (I.showLoading(d.lang("uploadLoading")), U.submit(), qa.val(""));
                            else {
                                var e = b.trim(T.val()),
                                    f = M.val(),
                                    h = K.val(),
...
KindEditor.plugin("media", function (b) {
    ...
    d.plugin.media = {
        edit: function () {
                var l = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + f.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
                        '<input type="button" class="ke-upload-button" value="' + f.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + f.viewServer + '" />', '</span></div><div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + f.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" /></div><div class="ke-dialog-row">', '<label for="keHeight" style="width:60px;">' +
                        f.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /></div><div class="ke-dialog-row">', '<label for="keAutostart">' + f.autostart + "</label>", '<input type="checkbox" id="keAutostart" name="autostart" value="" /> </div></div>'
                    ].join(""),
                    s = d.createDialog({
                        name: "media",
                        width: 450,
    ...
    b.extend(d, {
        init: function (d) {
            ...
            e.div = b(d.container).html(['<div class="ke-swfupload"><div class="ke-swfupload-top"><div class="ke-inline-block ke-swfupload-button"><input type="button" value="Browse" /></div>', '<div class="ke-inline-block ke-swfupload-desc">' + d.uploadDesc +
                "</div>", '<span class="ke-button-common ke-button-outer ke-swfupload-startupload">', '<input type="button" class="ke-button-common ke-button" value="' + d.startButtonValue + '" />', '</span></div><div class="ke-swfupload-body"></div></div>'
            ].join(""));
...
(function () {
    ...
    SWFUpload.prototype.buildParamString = function () {
        var b = this.settings.post_params,
            d = [];
        if (typeof b === "object")
            for (var f in b) b.hasOwnProperty(f) && d.push(encodeURIComponent(f.toString()) + "=" + encodeURIComponent(b[f].toString()));
        return d.join("&amp;")
    };
...
KindEditor.plugin("quickformat", function (b) {
    ...
    f.clickToolbar("quickformat", function () {
        ...
        for (var e = f.edit.doc, h = f.cmd.range, m = b(e.body).first(), n, o = [], l = [], s = h.createBookmark(!0); m;) {
            ...
            var v = d(m);
            if (!v || v.name != "img")
                if (j[m.name] ? (m.html(m.html().replace(/^(\s|&nbsp;|\u3000)+/ig, "")), m.css("text-indent", "2em")) : l.push(m), !n || j[n.name] || j[m.name] && !j[n.name]) l.length >
                    0 && o.push(l), l = [];
            m = n
        }
    ...
    e.plugin.table = {
        prop: function (n) {
            var o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keRows" style="width:90px;">' + h.cells + "</label>", h.rows + ' <input type="text" id="keRows" class="ke-input-text ke-input-number" name="rows" value="" maxlength="4" /> &nbsp; ',
                    ...
                    h.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', '</div><div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + h.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span></div></div>'
                ].join(""),
            ...
            var n = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + h.size + "</label>", h.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ',
                    ...
                    '</select></div><div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + h.border + "</label>", h.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', h.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', '</div><div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + h.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span></div></div>'
                ].join(""),
            ...
            for (h = m; h >= 0; h--)
                if (d = f.rows[h].cells, d.length > r) {
...
KindEditor.plugin("template", function (b) {
    ...
    f.clickToolbar("template", function () {
        ...
        html = [h.join(""), '</select></div><div class="ke-right">',
            '<input type="checkbox" id="keReplaceFlag" name="replaceFlag" value="1" /> <label for="keReplaceFlag">' + e.replaceContent + "</label>", '</div><div class="ke-clearfix"></div></div><iframe class="ke-textarea" frameborder="0" style="width:458px;height:260px;background-color:#FFF;"></iframe></div>'
        ].join("");
