...
class Common {
	...
	public static function exitWithMessage($message_detail, $forward_url, $second = 3,$type="message",$moban="message.html") {
	...
	public static function exitWithSuccess($message_detail, $forward_url, $second = 3 ,$type="success",$moban="message.html") {
